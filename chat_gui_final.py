...
class ChatPanel(wx.Panel):
    ...
    def __init__(self, parent_frame):
        ...
        self.radio_box = wx.RadioBox(self, choices=self.choices,
                                     majorDimension=1, style=wx.RA_SPECIFY_COLS)

        self.radio_box.Bind(wx.EVT_RADIOBOX, self.onRadioBox)
        ...
        self.switch_color.Bind(wx.EVT_BUTTON, self.change_color)
    ...
    def onRadioBox(self, e):
        print self.radio_box.GetStringSelection(), ' is clicked from Radio Box'
    ...
    def play_song(self, time_passed):
        ...
        while True:
            while SONGS_TO_PLAY:
                ...
                song_length = int(song2.info.length)
                print song_length
    ...
    def change_color(self, event):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            self.SetBackgroundColour(data.GetColour().Get())  # setting background color.
            self.Refresh()
